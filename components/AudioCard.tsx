  ...
  return (
    <View style={globalStyles.card}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            >
                <Ionicons name="mic" size={32} color="#2bb2e9" />
                <View>
            ...
            <View>
                <Ionicons name="play" size={32} color="#2bb2e9" onPress={() => router.push({ pathname: '/[modals]/audio/preview', params: { uri: item.uri, duration: item.duration } })} />
            </View>
        </View>
    </View>
  );
